...
| Cake.Issues.Recipe Property        | Cake.Issues.FrostingRecipe Property        | Default Value    | Description                                                                                                                                              |
|------------------------------------|--------------------------------------------|------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| Cake.Issues.Recipe Methods                                     | Cake.Issues.FrostingRecipe Methods                                     | Description                                                                |
|----------------------------------------------------------------|------------------------------------------------------------------------|----------------------------------------------------------------------------|
...
| Cake.Issues.Recipe Property                                | Cake.Issues.FrostingRecipe Property                               | Default Value | Description                                             |
|------------------------------------------------------------|-------------------------------------------------------------------|---------------|---------------------------------------------------------|
| `IssuesParameters.Reporting.ShouldCreateFullIssuesReport`  | Not supported                                                     | `true`        | Indicates whether full issues report should be created. |
...
| `IssuesParameters.BuildServer.ShouldCreateSummaryIssuesReport` | Not supported                                                          | `true`        | Indicates whether summary issues report should be created.                                |
